namespace PRL.f_ChucNang
{
	partial class f_Voucher
	{
		...
		private void InitializeComponent()
		{
			...
			label5.Location = new Point(43, 296);
			label5.Name = "label5";
			...
			label9.Location = new Point(43, 398);
			label9.Name = "label9";
			...
			btn_Update.Location = new Point(353, 500);
			...
			btn_Add.Location = new Point(155, 500);
			...
			label7.Location = new Point(43, 194);
			label7.Name = "label7";
			...
			label4.Location = new Point(43, 246);
			label4.Name = "label4";
			...
			dgv_Voucher.Location = new Point(5, 98);
			dgv_Voucher.Margin = new Padding(3, 2, 3, 2);
			...
			dgv_Voucher.Size = new Size(840, 596);
			...
			cbx_TrangThaiFind.Location = new Point(286, 56);
			cbx_TrangThaiFind.Margin = new Padding(3, 2, 3, 2);
			cbx_TrangThaiFind.Name = "cbx_TrangThaiFind";
			cbx_TrangThaiFind.Size = new Size(231, 22);
