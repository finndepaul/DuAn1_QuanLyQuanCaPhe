namespace PRL.f_ChucNang
{
	partial class f_KhachHang
	{
		...
		private void InitializeComponent()
		{
			...
			cbx_TimKiemTheoRank.Location = new Point(346, 407);
			cbx_TimKiemTheoRank.Margin = new Padding(3, 2, 3, 2);
			cbx_TimKiemTheoRank.Name = "cbx_TimKiemTheoRank";
			cbx_TimKiemTheoRank.Size = new Size(224, 23);
			cbx_TimKiemTheoRank.TabIndex = 8;
			cbx_TimKiemTheoRank.SelectedIndexChanged += cbx_TimKiemTheoRank_SelectedIndexChanged;
			// 
			// txt_TimKiemRank
			// 
			txt_TimKiemRank.Location = new Point(5, 407);
			txt_TimKiemRank.Margin = new Padding(3, 2, 3, 2);
			txt_TimKiemRank.Name = "txt_TimKiemRank";
			txt_TimKiemRank.Size = new Size(256, 23);
			...
			btn_Sua.Location = new Point(315, 343);
			btn_Sua.Margin = new Padding(3, 2, 3, 2);
			btn_Sua.Name = "btn_Sua";
			btn_Sua.Size = new Size(122, 38);
			btn_Sua.TabIndex = 15;
			btn_Sua.Text = "Sửa";
			...
			btn_Them.Location = new Point(123, 343);
			btn_Them.Margin = new Padding(3, 2, 3, 2);
			btn_Them.Name = "btn_Them";
			btn_Them.Size = new Size(122, 38);
			...
			// txt_IDRank
			// 
			txt_IDRank.Location = new Point(206, 244);
			txt_IDRank.Margin = new Padding(3, 2, 3, 2);
			txt_IDRank.Name = "txt_IDRank";
			txt_IDRank.Size = new Size(306, 23);
			txt_IDRank.TabIndex = 13;
			// 
			// txt_Point
			// 
			txt_Point.Location = new Point(206, 202);
			txt_Point.Margin = new Padding(3, 2, 3, 2);
			txt_Point.Name = "txt_Point";
			txt_Point.Size = new Size(306, 23);
			txt_Point.TabIndex = 12;
			// 
			// txt_IDNhanVien
			// 
			txt_IDNhanVien.Location = new Point(206, 290);
			txt_IDNhanVien.Margin = new Padding(3, 2, 3, 2);
			txt_IDNhanVien.Name = "txt_IDNhanVien";
			txt_IDNhanVien.Size = new Size(306, 23);
			...
			dgv_Membership.Location = new Point(5, 433);
			dgv_Membership.Margin = new Padding(3, 2, 3, 2);
			...
			dgv_Membership.Size = new Size(907, 265);
			...
			dgv_KhachHang.Location = new Point(5, 85);
			dgv_KhachHang.Margin = new Padding(3, 2, 3, 2);
			...
			dgv_KhachHang.Size = new Size(907, 260);
			dgv_KhachHang.TabIndex = 4;
			dgv_KhachHang.CellClick += dgv_KhachHang_CellClick;
			// 
			// txt_SoDienThoai
			// 
			txt_SoDienThoai.Location = new Point(206, 71);
			txt_SoDienThoai.Margin = new Padding(3, 2, 3, 2);
			txt_SoDienThoai.Name = "txt_SoDienThoai";
			txt_SoDienThoai.Size = new Size(306, 23);
			txt_SoDienThoai.TabIndex = 10;
			// 
			// txt_Email
			// 
			txt_Email.Location = new Point(206, 114);
			txt_Email.Margin = new Padding(3, 2, 3, 2);
			txt_Email.Name = "txt_Email";
			txt_Email.Size = new Size(306, 23);
			txt_Email.TabIndex = 9;
			// 
			// txt_TenKhachHang
			// 
			txt_TenKhachHang.Location = new Point(206, 26);
			txt_TenKhachHang.Margin = new Padding(3, 2, 3, 2);
			txt_TenKhachHang.Name = "txt_TenKhachHang";
			txt_TenKhachHang.Size = new Size(306, 23);
			...
			label7.Location = new Point(34, 202);
			label7.Name = "label7";
			...
			label10.Location = new Point(346, 374);
			...
			// 
			txt_TimKiemIdKhachHang.Location = new Point(248, 39);
			txt_TimKiemIdKhachHang.Margin = new Padding(3, 2, 3, 2);
			txt_TimKiemIdKhachHang.Name = "txt_TimKiemIdKhachHang";
			txt_TimKiemIdKhachHang.Size = new Size(256, 23);
			txt_TimKiemIdKhachHang.TabIndex = 3;
			txt_TimKiemIdKhachHang.TextChanged += txt_TimKiemIdKhachHang_TextChanged;
			// 
			// txt_DiaChi
			// 
			txt_DiaChi.Location = new Point(206, 158);
			txt_DiaChi.Margin = new Padding(3, 2, 3, 2);
			txt_DiaChi.Name = "txt_DiaChi";
			txt_DiaChi.Size = new Size(306, 23);
			...
			label5.Location = new Point(34, 158);
			label5.Name = "label5";
			...
			label9.Location = new Point(0, 374);
			label9.Name = "label9";
			label9.Size = new Size(210, 19);
			label9.TabIndex = 1;
			...
			groupBox1.Size = new Size(560, 698);
			...
			btn_UpdateMemberShip.Location = new Point(315, 599);
			btn_UpdateMemberShip.Margin = new Padding(3, 2, 3, 2);
			btn_UpdateMemberShip.Name = "btn_UpdateMemberShip";
			btn_UpdateMemberShip.Size = new Size(122, 38);
			...
			btn_ThemMemberShip.Location = new Point(123, 599);
			btn_ThemMemberShip.Margin = new Padding(3, 2, 3, 2);
			btn_ThemMemberShip.Name = "btn_ThemMemberShip";
			btn_ThemMemberShip.Size = new Size(122, 38);
			...
			// txt_PointsNeed
			// 
			txt_PointsNeed.Location = new Point(206, 483);
			txt_PointsNeed.Margin = new Padding(3, 2, 3, 2);
			txt_PointsNeed.Name = "txt_PointsNeed";
			txt_PointsNeed.Size = new Size(306, 23);
			txt_PointsNeed.TabIndex = 13;
			// 
			// txt_RankName
			// 
			txt_RankName.Location = new Point(206, 433);
			txt_RankName.Margin = new Padding(3, 2, 3, 2);
			txt_RankName.Name = "txt_RankName";
			txt_RankName.Size = new Size(306, 23);
			txt_RankName.TabIndex = 12;
			// 
			// txt_Discount
			// 
			txt_Discount.Location = new Point(206, 533);
			txt_Discount.Margin = new Padding(3, 2, 3, 2);
			txt_Discount.Name = "txt_Discount";
			txt_Discount.Size = new Size(306, 23);
			...
			label12.Location = new Point(34, 432);
			...
			label11.Location = new Point(34, 482);
			...
			label1.Location = new Point(34, 532);
			label1.Name = "label1";
			...
			ID_NhanVien.Location = new Point(34, 290);
			ID_NhanVien.Name = "ID_NhanVien";
			ID_NhanVien.Size = new Size(104, 19);
			...
			groupBox2.Location = new Point(576, 9);
			groupBox2.Margin = new Padding(3, 2, 3, 2);
			groupBox2.Name = "groupBox2";
			groupBox2.Padding = new Padding(3, 2, 3, 2);
			groupBox2.Size = new Size(918, 702);
