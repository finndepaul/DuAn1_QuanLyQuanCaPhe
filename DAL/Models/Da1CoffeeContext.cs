...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IddichVuPhatSinh).HasName("PK__DichVuPh__87E4E2CE92715FF7");
        ...
        {
            entity.HasKey(e => e.IdgiamGiaChiTiet).HasName("PK__GiamGiaC__F7895F4A28DD861E");
        ...
        {
            entity.HasKey(e => e.IdgiamGia).HasName("PK__GiamGia__F091CBDC625D4943");
        ...
        {
            entity.HasKey(e => e.IdhoaDon).HasName("PK__HoaDon__5B896F4925AA579C");
        ...
        {
            entity.HasKey(e => e.IdhoaDonChiTiet).HasName("PK__HoaDonCh__21C236775F7EF98D");
        ...
        {
            entity.HasKey(e => e.Sdt).HasName("PK__KhachHan__CA1930A44D2C3B60");
        ...
        {
            entity.HasKey(e => e.IdloaiSanPham).HasName("PK__LoaiSanP__6CB987C5AC669827");
        ...
        {
            entity.HasKey(e => e.Idrank).HasName("PK__MemberSh__AFFF681D798673B3");
        ...
        {
            entity.HasKey(e => e.IdnguyenLieu).HasName("PK__NguyenLi__209F08FF8E7C2BF8");
        ...
        {
            entity.HasKey(e => e.IdnhanVien).HasName("PK__NhanVien__7AC2D9F72D5671B3");
        ...
        {
            entity.HasKey(e => e.IdphaChe).HasName("PK__PhaChe__1035F7DEAD2A331A");
        ...
        {
            entity.HasKey(e => e.IdsanPham).HasName("PK__SanPham__9D45E58AFD365030");
        ...
        {
            entity.HasKey(e => e.Idvoucher).HasName("PK__Voucher__50249A2730D47C91");
