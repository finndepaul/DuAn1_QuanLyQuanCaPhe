...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IddichVuPhatSinh).HasName("PK__DichVuPh__87E4E2CE849C436E");
        ...
        {
            entity.HasKey(e => e.IdhoaDon).HasName("PK__HoaDon__5B896F49EE50ED20");
        ...
        {
            entity.HasKey(e => e.IdhoaDonChiTiet).HasName("PK__HoaDonCh__21C23677E8674586");
        ...
        {
            entity.HasKey(e => e.IdkhachHang).HasName("PK__KhachHan__5A7167B562340C6E");
        ...
        {
            entity.HasKey(e => e.IdloaiSanPham).HasName("PK__LoaiSanP__6CB987C5429D61E2");
        ...
        {
            entity.HasKey(e => e.Idrank).HasName("PK__MemberSh__AFFF681D4FA1FABD");
        ...
        {
            entity.HasKey(e => e.IdnguyenLieu).HasName("PK__NguyenLi__209F08FF8B907999");
        ...
        {
            entity.HasKey(e => e.IdnhanVien).HasName("PK__NhanVien__7AC2D9F7E8485D14");
        ...
        {
            entity.HasKey(e => e.IdphaChe).HasName("PK__PhaChe__1035F7DE9F02447B");
        ...
        {
            entity.HasKey(e => e.Idsale).HasName("PK__Sale__C6F3BA0B260CFDA5");
        ...
        {
            entity.HasKey(e => e.IdsanPham).HasName("PK__SanPham__9D45E58AAD8B7F49");
        ...
        {
            entity.HasKey(e => e.Idvoucher).HasName("PK__Voucher__50249A271FC4238E");
